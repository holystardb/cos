...
#define LOG_CHECKPOINT_ARCHIVED_LSN     28
#define LOG_CHECKPOINT_GROUP_ARRAY      36
...
extern status_t log_group_file_read(log_group_t* group, byte* buf, uint32 len, uint64 byte_offset);
