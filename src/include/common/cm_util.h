...
inline uint32 mach_read_from_2(
...
inline uint32 mach_read_from_3(
    const unsigned char*    b); /*!< in: pointer to 3 bytes */

/*******************************************************//**
The following function is used to store data in four consecutive
bytes. We store the most significant char to the lowest address. */
inline void mach_write_to_4(
...
inline uint64 mach_read_from_6(
...
inline uint64 mach_read_from_7(
    const unsigned char*    b); /*!< in: pointer to 7 bytes */

/*******************************************************//**
The following function is used to store data in 8 consecutive
bytes. We store the most significant char to the lowest address. */
inline void mach_write_to_8(
...
inline uint64 mach_read_from_8(
    const unsigned char*    b); /*!< in: pointer to 8 bytes */

/*********************************************************//**
Writes a 64-bit integer in a compressed form (5..9 bytes).
@return size in bytes */
inline uint32 mach_ull_write_compressed(
    unsigned char*      b,  /*!< in: pointer to memory where to store */
    uint64  n); /*!< in: 64-bit integer to be stored */
...
@return compressed size in bytes */
inline uint32 mach_ull_get_compressed_size(
    uint64  n); /*!< in: 64-bit integer to be stored */

/*********************************************************//**
Reads a 64-bit integer in a compressed form.
@return the value read */
inline uint64 mach_ull_read_compressed(
    const unsigned char*    b); /*!< in: pointer to memory from where to read */

/*********************************************************//**
Writes a 64-bit integer in a compressed form (1..11 bytes).
@return size in bytes */
inline uint32 mach_ull_write_much_compressed(
    unsigned char*  b,  /*!< in: pointer to memory where to store */
    uint64  n); /*!< in: 64-bit integer to be stored */
...
Returns the size of a 64-bit integer when written in the compressed form.
@return compressed size in bytes */
inline uint32 mach_ull_get_much_compressed_size(
    uint64  n); /*!< in: 64-bit integer to be stored */

/*********************************************************//**
Reads a 64-bit integer in a compressed form.
@return the value read */
inline uint64 mach_ull_read_much_compressed(
    const unsigned char*    b); /*!< in: pointer to memory from where to read */

/*********************************************************//**
Reads a uint32 in a compressed form if the log record fully contains it.
@return pointer to end of the stored field, NULL if not complete */
inline unsigned char* mach_parse_compressed(
