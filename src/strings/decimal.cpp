...
int decimal2bin(decimal_t *from, uchar *to, int precision, int frac)
{
  ...
  if (intg1x)
  {
    ...
    switch (i)
    {
      case 1: int1store(to, x); break;
      case 2: int2store(to, x); break;
      case 3: int3store(to, x); break;
      case 4: int4store(to, x); break;
    default: assert(0);
    }
    to+=i;
  }
...
int bin2decimal(const uchar *from, decimal_t *to, int precision, int scale)
{
  ...
  if (intg0x)
  {
    ...
    switch (i)
    {
      case 1: x=sint1korr(from); break;
      case 2: x=sint2korr(from); break;
      case 3: x=sint3korr(from); break;
      case 4: x=sint4korr(from); break;
    default: assert(0);
    }
    from+=i;
    *buf=x ^ mask;
